...
import copy
from dgp import Weibull_linear, Weibull_nonlinear, Weibull_log_linear, Exp_linear, LogNormal_linear, LogNormalCox_linear, LogNormal_nonlinear
...
if __name__ == "__main__":
    ...
    model1 = LogNormal_nonlinear(n_features, 4, device = device)
    model2 = LogNormal_nonlinear(n_features, 4, device = device)
