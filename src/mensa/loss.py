...
def calculate_loss_one_model(model, data, event_name='T1'):#estimates loss assuming every thing is observed/no censoring for checking 
...
def calculate_loss_three_models(model1, model2, model3, data, copula=None):#estimates the joint loss
    s1 = model1.survival(data['T'], data['X'])
    s2 = model2.survival(data['T'], data['X'])
