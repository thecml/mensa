...
from utility.survival import make_stratified_split, convert_to_structured, make_time_bins
...
from models import MultiEventCoxPH, MultiTaskLossWrapper
...
if __name__ == "__main__":
    ...
    dataset = [raw_data, binned_event_time, labels, min_time, max_time] # first event only
